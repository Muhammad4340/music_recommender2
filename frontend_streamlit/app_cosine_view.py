...
if st.button('Show Recommendation'):
    ...
    recommended_music_names, recommended_music_posters, similarity_scores = recommend(selected_movie, num_recommendations)
    ...
    for i in range(rows):
        ...
        for j in range(num_cols):
            ...
            if index < num_recommendations:
                cols[j].text(f"{recommended_music_names[index]} (Similarity: {similarity_scores[index]:.2f})")
